      ...
      <div>
          ...
          token ? <div className='flex items-center gap-2 cursor-pointer group-relative'>
            ...
            <div className='absolute top-12 right-0 text-base font-medium text-gray-600 '>
              ...
              <div className='min-w-848 bg-stone rounded flex flex-col gap-4 p-4'>
                ...
                <p onClick={() => navigate(false)} className='hover:text-black cursor-pointer'>Logout</p>
              </div>
            </div>
        ...
        <div className={`${showMenu ? `fixed w-full` : `h-0 w-0`} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
            ...
            <NavLink onClick={() => { setShowMenu(false) }} to='/icons'><p className="px-4 py-2 rounded  inline-block ">ICONS</p></NavLink>
          </ul>
        </div>
      </div>
    </div>
