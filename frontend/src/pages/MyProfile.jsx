...
const MyProfile = () => {
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm '>
      ...
      {
        isEdit ?
          <input className='bg-gray-50 text-3xl font-medium max-w-60 mt-4 ' value={userData.name} onChange={(e) => { setUserData(prev => ({ ...prev, name: e.target.value })) }} type="text" /> : <p className='font-medium text-3xl text-neutral-800 mt-4'>{userData.name}</p>
      }
      ...
      <div className=''>
        ...
        <div>
          ...
          <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 text-neutral-700' >
            ...
            {
              isEdit ?
                <select className='max-w-20 bg-gray-100' onChange={(e) => setUserData(prev => ({ ...prev, gender: e.target.value }))}><option value="male">male</option>
